    ...
    return (
        <section className="relative py-20 pb-24 max-[980px]:py-12 max-[980px]:pb-16 max-[560px]:py-8 max-[560px]:pb-12 bg-gradient-to-b from-[#faf5ff] to-white overflow-hidden before:content-[''] before:absolute before:-top-[200px] before:-left-[100px] before:w-[600px] before:h-[600px] before:bg-[radial-gradient(circle,rgba(139,92,246,0.15)_0%,transparent_70%)] before:pointer-events-none before:z-0 after:content-[''] after:absolute after:-bottom-[150px] after:-right-[150px] after:w-[500px] after:h-[500px] after:bg-[radial-gradient(circle,rgba(124,58,237,0.1)_0%,transparent_70%)] after:pointer-events-none after:z-0">
            <div className="max-w-[1200px] mx-auto px-4 max-[560px]:px-3 relative z-10 grid grid-cols-[1.1fr_0.9fr] max-[980px]:grid-cols-1 gap-16 max-[980px]:gap-8 max-[560px]:gap-6 items-center">
                <div className="animate-[fadeInUp_0.8s_ease-out_forwards] flex flex-col items-start max-[560px]:items-center text-left max-[560px]:text-center w-full">
                    <h1 className="text-[52px] max-[980px]:text-[36px] max-[560px]:text-[28px] leading-[1.1] my-5 max-[560px]:my-3 font-extrabold text-[var(--text)] animate-[fadeInUp_0.8s_ease-out_0.3s_backwards] w-full">
                        Get paid safely. Pay with confidence.
                    </h1>
                    <p className="text-[19px] max-[980px]:text-[17px] max-[560px]:text-[15px] text-[var(--muted)] max-w-[640px] leading-[1.7] animate-[fadeInUp_0.8s_ease-out_0.5s_backwards] w-full">
                        <span className="max-[560px]:inline-block">Smart‑payment contracts for buyers and sellers.</span>
                        <span className="max-[560px]:hidden"> Funds locked safely, released milestone by milestone.</span>
                    </p>
                    <div className="flex gap-4 max-[560px]:gap-3 flex-wrap mt-8 max-[560px]:mt-6 animate-[fadeInUp_0.8s_ease-out_0.7s_backwards] justify-start max-[980px]:justify-center flex-row max-[560px]:flex-row max-[560px]:justify-center max-[560px]:w-full">
                        <a className="inline-flex items-center gap-3 max-[560px]:gap-2 px-6 max-[560px]:px-4 py-3 max-[560px]:py-2.5 rounded-xl bg-black text-white transition-all border-none min-w-[160px] max-w-[220px] max-[560px]:min-w-[140px] max-[560px]:max-w-full hover:-translate-y-0.5 hover:shadow-[0_8px_20px_rgba(0,0,0,0.2)]" href="#download">
                            ...
                            <div className="flex flex-col items-start max-[560px]:items-center leading-tight">
