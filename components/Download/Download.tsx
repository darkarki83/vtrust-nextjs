    ...
    <section id="download" className="py-24 bg-gradient-to-br from-[#667eea] to-[#764ba2] text-white text-center scroll-mt-20">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="flex gap-4 flex-wrap justify-center mt-8">
          <a
            className="inline-flex items-center gap-3 px-6 py-3 rounded-xl bg-black text-white transition-all border-none min-w-[160px] cursor-pointer hover:-translate-y-0.5 hover:shadow-[0_8px_20px_rgba(0,0,0,0.2)]"
