  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 border-b border-[rgba(234,234,241,0.5)] shadow-sm" style={{ backdropFilter: 'saturate(180%) blur(12px)' }}>
      <div className="max-w-[1200px] mx-auto px-6 flex items-center justify-between h-[70px]">
        ...
        >
          <img className="h-10 block object-contain" src="/logo/logo_transparent.png" alt="VTrust" />
        </a>
        <nav className="flex gap-8 items-center">
          ...
          <a
            href="#download"
            className="inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-[10px] bg-gradient-to-br from-[var(--brand)] to-[var(--brand-2)] text-white font-semibold text-sm transition-all duration-200 whitespace-nowrap shadow-[0_2px_8px_rgba(139,92,246,0.3)] hover:shadow-[0_4px_16px_rgba(139,92,246,0.4)] hover:-translate-y-px hover:scale-[1.02]"
          >
            Get Started
          </a>
        </nav>
